 ...
 */
public class TextFileFilter extends javax.swing.filechooser.FileFilter implements FileFilter {
	...
	public boolean accept(File f) {
    	if (f != null) {
    	    ...
    	    if (extension != null && (extension.compareTo("txt") == 0 || (extension.compareTo("dat") == 0))) {
    	    	return true;
    	    }
    	}
    	return false;
