...
/**
 * This class implements a filter for OGG files.
 * 
 * @author Markus Schedl
 */
public class OGGFileFilter extends javax.swing.filechooser.FileFilter implements FileFilter {
	...
	public boolean accept(File f) {
    	if (f != null) {
    	    ...
    	    if (extension != null && (extension.compareTo("ogg") == 0)) {
    	    	return true;
    	    }
    	}
    	return false;
