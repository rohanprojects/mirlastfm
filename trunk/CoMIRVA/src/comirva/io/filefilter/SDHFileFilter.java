...
/**
 * This class implements a FileFilter for *.sdh files
 * which are Object-Files for SDH-instances and used
 * to load and store SDH-objects.
 * 
 * @author Markus Schedl
 */
public class SDHFileFilter extends javax.swing.filechooser.FileFilter implements FileFilter {
	...
	public boolean accept(File f) {
    	if (f != null) {
    	    ...
    	    if (extension != null && (extension.compareTo("sdh") == 0)) {
    	    	return true;
    	    }
    	}
    	return false;
     ...
     public String getDescription() {
     	return "Smoothed Data Histograms (*.sdh)";
     }
