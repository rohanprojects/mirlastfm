 ...
 * 
 */
public class SimpleNetworkGraphVisualizer {
    ...
    public SimpleNetworkGraphVisualizer() {
    ...
    public void setGraph(Graph<Integer, Number> graph) {
		this.graph = graph;
	}
    
    public static Graph<Integer, Number> getTestGraph() {
		...
		graph.addEdge(0.543, 1, 2);
		graph.addEdge(0.0004, 2, 3);
...
//        vv.getRenderContext().setEdgeDrawPaintTransformer(new PickableEdgePaintTransformer<Number>(vv.getPickedEdgeState(), Color.black, Color.lightGray));
    ...
    {
        SimpleNetworkGraphVisualizer vis = new SimpleNetworkGraphVisualizer();
        vis.setGraph(getTestGraph());
        vis.init();
