...
/**
 * This class implements a FileFilter for *.som files
 * which are Object-Files for SOM-instances and used
 * to load and store SOM-objects.
 * 
 * @author Markus Schedl
 */
public class SOMFileFilter extends javax.swing.filechooser.FileFilter implements FileFilter {
	...
	public boolean accept(File f) {
    	if (f != null) {
    	    ...
    	    if (extension != null && (extension.compareTo("som") == 0)) {
    	    	return true;
    	    }
    	}
    	return false;
     ...
     public String getDescription() {
     	return "Self-Organizing Maps (*.som)";
     }
