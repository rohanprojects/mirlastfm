...
/**
 * This class implements a FileFilter for *.eps files
 * which are Encapsulated PostScript files and used to store the content of the
 * visualization pane.
 *
 * @author Markus Schedl
 */
public class EPSFileFilter extends javax.swing.filechooser.FileFilter implements FileFilter {
	...
	public boolean accept(File f) {
    	if (f != null) {
    	    ...
    	    if (extension != null && (extension.compareTo("eps") == 0)) {
    	    	return true;
    	    }
    	}
    	return false;
