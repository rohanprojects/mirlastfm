...
public class ConsineSimilarityGoogleTagCloud extends AbstractSimilartityMeasure {


	public ConsineSimilarityGoogleTagCloud(int id, String name, List<MirArtist> artistList) {
	...
	protected double calcSimilarity(MirArtist artistA, MirArtist artistB) {
		...
		if (artistA.getGoogleTagCloudFeature() != null && artistB.getGoogleTagCloudFeature() != null) {
			
			if (artistA.getGoogleTagCloudFeature().getTopTags() != null && artistA.getGoogleTagCloudFeature().getTopTags() != null) {
				Map<String,Integer> artistATags = artistA.getGoogleTagCloudFeature().getTopTags();
				Map<String,Integer> artistBTags = artistB.getGoogleTagCloudFeature().getTopTags();
